...
from src.preprocessing.training_preproc import pipeline_training_preproc
...
def main_inference(cfg: data_config):
    ...
    # make inference
    df = pipeline_inference_preproc(cfg=cfg).fit_transform(df_inference)
...
if __name__ == "__main__":
    ...
    # start program
    df = main(cfg = cfg, api_download = False , training = False, inference = True )
